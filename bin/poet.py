...
def main(args=sys.argv):
    ...
    if args.line_length:
        poet_filters.append(poetryutils2.filtersline_length_filter(args.line_length))
    if args.blacklist:
    ...
    if args.letter_ratio:
        poet_filters.append(poetryutils2.filters.low_letter_filter(args.letter_ratio))
    if args.url_filter:
    ...
    if args.re:
        poet_filters.append(poetryutils2.filters.regex_filter(args.re, args.ignore_case))
